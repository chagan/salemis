		...
		<div id="content">
			...
			<div class="hfeed">
				...
				<div id="post-0" class="<?php hybrid_entry_class(); ?>">
					...
					<h1 class="error-404-title entry-title">Uh oh, I don't think you meant to come here</h1>
					
					<div class="entry-content">
	
						<p>
						<img src="http://salemis.org/wp-content/uploads/2013/02/keizer.jpg" alt="Wecome to Keizer sign"/>
